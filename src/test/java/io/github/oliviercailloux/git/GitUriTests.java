...
class GitUriTests {
  ...
  void testUri() throws Exception {
    ...
    assertThrows(URISyntaxException.class,
        () -> new URI("git@github.com:oliviercailloux/testrel.git"));
  ...
  void testUrisSsh() throws Exception {
    ...
    assertEquals(GitUri.fromUri(URI.create("ssh://file/something")),
        GitUri.fromGitUrl("file:/something"));
  }
  ...
  void testUrisFile() throws Exception {
    ...
    assertEquals(URI.create("file:///path/to/repo.git"),
        GitUri.fromGitUrl("/path/to/repo.git/").asUri());
    ...
    assertEquals("file:///somepath",
        GitUri.fromUri(URI.create("file:/somepath")).asUri().toString());
  ...
  void testUrisIllegal() throws Exception {
    assertThrows(IllegalArgumentException.class,
        () -> GitUri.fromUri(URI.create("file:./path/to/repo.git/")));
