...
public abstract class GitPathImpl implements Path, GitPath {
	...
	private static final Comparator<GitPathImpl> COMPARATOR = Comparator.<GitPathImpl, String>comparing(Path::toString);
	...
	private static class TransformedPeekingIterator<E> implements PeekingIterator<GitPathImpl> {
		...
		public TransformedPeekingIterator(PeekingIterator<E> delegate, Function<E, GitPathImpl> transform) {
	...
	private static class PathIterator implements PeekingIterator<GitPathImpl> {
		...
		public PathIterator(PeekingIterator<GitPathImpl> unfilteredIterator, Filter<? super GitPathImpl> filter) {
